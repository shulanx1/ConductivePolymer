...
M = readtable('E:\data\polymer\pool_Naconcentration.xlsx', 'Sheet','excitability_0Na');
% M = readtable('E:\data\dendritic patch\pool\pass_filter.xlsx', 'Sheet','morph');
base_path = 'E:\data';
save_path = 'E:\data\polymer\sub&supra_0Na';
...
for i = 1:size(M, 1)
    ...
    [params_post_temp, ~, f_post_temp, I_temp, AP_amp_post_temp, AP_width_post_temp] = sub_and_supra_classify(data_path, M.date{i}, M.cell(i), M.post(i),0,1,save_path, 0);
...
save(fullfile(save_path,'excitability_0Na_pool.mat'),'Rm','Cm','AP_amp','AP_width', 'Ihold','I_temp','f_pre', 'f_post', 'anova_table', 'p', 'M')
%% na activation
clear all
close all
...
addpath(genpath(fullfile(pwd,'main')))
addpath(genpath(fullfile(pwd,'plotting')))
M = readtable('E:\data\polymer\pool_Naconcentration.xlsx', 'Sheet','na_activation_0Na');
base_path = 'E:\data';
...
for i = 1:size(M, 1)
    ...
    [Na_amp_post(i,:), ~, Vstep(i,:)] = na_activation(data_path, M.date{i}, M.cell(i), M.post(i), nan, 0,1,save_path, 0);
end
...
save(fullfile(save_path,'na_activation_0Na_pool.mat'),'G_pre','G_post','Vstep','anova_table','p','M')
...
addpath(genpath(fullfile(pwd,'main')))
addpath(genpath(fullfile(pwd,'plotting')))
M = readtable('E:\data\polymer\pool_Naconcentration.xlsx', 'Sheet','ca_activation_0Na');
base_path = 'E:\data';
save_path = 'E:\data\polymer\ca_activation_0Na';
if ~exist(save_path, 'dir')
    mkdir(save_path)
end
...
for i = 1:size(M, 1)
    ...
    [Na_amp_post(i,:), ~, Vstep(i,:)] = ca_activation(data_path, M.date{i}, M.cell(i), M.post(i), nan, 0,1,save_path, 0);
end
G_pre = Na_amp_pre./(Vstep-53.9);
G_post = Na_amp_post./(Vstep-53.9);
ft = fittype('G*(1/(1+exp(-(x-Vh)/k)))', 'independent', 'x');
...
save(fullfile(save_path,'ca_activation_0Na_pool.mat'),'G_pre','G_post','Vstep','anova_table','p','M')
%% na inactivation
clear all
close all
...
M = readtable('E:\data\polymer\pool_Naconcentration.xlsx', 'Sheet','na_inactivation_0Na');
% M = readtable('E:\data\dendritic patch\pool\pass_filter.xlsx', 'Sheet','morph');
base_path = 'E:\data';
save_path = 'E:\data\polymer\na_inactivation_0Na';
if ~exist(save_path, 'dir')
...
for i = 1:size(M, 1)
    ...
    [Na_act_post(i,:),~,Na_in_post(i,:), ~, K_post(i,:), Vstep(i,:)] = na_inactivation(data_path, M.date{i}, M.cell(i), M.post(i), nan, 0,1,save_path, 0);
end
...
save(fullfile(save_path,'na_inactivation_0Na.mat'),'Vstep','GNain_pre','GNain_post','GNaact_pre','GNaact_post','GK_pre','GK_post','anova_table','p','M')
%% na recovery
clear all
% close all
...
M = readtable('E:\data\polymer\pool_Naconcentration.xlsx', 'Sheet','na_recovery_0Na');
% M = readtable('E:\data\dendritic patch\pool\pass_filter.xlsx', 'Sheet','morph');
base_path = 'E:\data';
save_path = 'E:\data\polymer\na_recovery_0Na';
if ~exist(save_path, 'dir')
...
save(fullfile(save_path,'na_recovery_0Na.mat'),'tstep','Na_rec_post_norm','Na_rec_pre_norm','anova_table','p','M')
%% excitability
clear all
close all
...
M = readtable('E:\data\polymer\pool_Naconcentration.xlsx', 'Sheet','excitability_92Na');
% M = readtable('E:\data\dendritic patch\pool\pass_filter.xlsx', 'Sheet','morph');
base_path = 'E:\data';
save_path = 'E:\data\polymer\sub&supra_92Na';
if ~exist(save_path, 'dir')
    mkdir(save_path)
end
Rm = [];
...
save(fullfile(save_path,'excitability_92Na_pool.mat'),'Rm','Cm','AP_amp','AP_width', 'Ihold','I_temp','f_pre', 'f_post', 'anova_table', 'p', 'M')
%% na activation
clear all
close all
...
addpath(genpath(fullfile(pwd,'main')))
addpath(genpath(fullfile(pwd,'plotting')))
M = readtable('E:\data\polymer\pool_Naconcentration.xlsx', 'Sheet','na_activation_92Na');
base_path = 'E:\data';
save_path = 'E:\data\polymer\na_activation_92Na';
if ~exist(save_path, 'dir')
    mkdir(save_path)
...
save(fullfile(save_path,'na_activation_92Na_pool.mat'),'G_pre','G_post','Vstep','anova_table','p','M')
%% ca activation (wo ttx)
clear all
close all
...
addpath(genpath(fullfile(pwd,'main')))
addpath(genpath(fullfile(pwd,'plotting')))
M = readtable('E:\data\polymer\pool_Naconcentration.xlsx', 'Sheet','ca_activation_92Na');
base_path = 'E:\data';
save_path = 'E:\data\polymer\ca_activation_92Na';
if ~exist(save_path, 'dir')
    mkdir(save_path)
end
...
save(fullfile(save_path,'ca_activation_92Na_pool.mat'),'G_pre','G_post','Vstep','anova_table','p','M')
%% na inactivation
clear all
close all
...
M = readtable('E:\data\polymer\pool_Naconcentration.xlsx', 'Sheet','na_inactivation_92Na');
% M = readtable('E:\data\dendritic patch\pool\pass_filter.xlsx', 'Sheet','morph');
base_path = 'E:\data';
save_path = 'E:\data\polymer\na_inactivation_92Na';
if ~exist(save_path, 'dir')
...
% colors = [[0,0,0];[159,186,149]/255]; % color for K rich polymer
% errorbar_with_fitcurve(Vstep(1,:), {GK_pre', GK_post'}, {curveK_pre,curveK_post},colors)
save(fullfile(save_path,'na_inactivation_92Na.mat'),'Vstep','GNain_pre','GNain_post','GNaact_pre','GNaact_post','GK_pre','GK_post','anova_table','p','M')
%% na recovery
clear all
% close all
...
M = readtable('E:\data\polymer\pool_Naconcentration.xlsx', 'Sheet','na_recovery_92Na');
% M = readtable('E:\data\dendritic patch\pool\pass_filter.xlsx', 'Sheet','morph');
base_path = 'E:\data';
save_path = 'E:\data\polymer\na_recovery_92Na';
if ~exist(save_path, 'dir')
...
% colors = [[0,0,0];[195,129,168]/255]; % color for pedotPSS
errorbar_with_fitcurve(tstep, {Na_rec_pre_norm', Na_rec_post_norm'}, {curveNarec_pre,curveNarec_post},colors), set(gca, 'XScale','log'), box on
save(fullfile(save_path,'na_recovery_92Na.mat'),'tstep','Na_rec_post_norm','Na_rec_pre_norm','anova_table','p','M')